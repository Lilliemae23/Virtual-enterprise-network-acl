...
![Admin PC IP Configuration](images/admin-ip-config.png)
...
![Ping Test Before ACL](images/admin-staff-ping.png)
...
![ACL Applied to Interface](images/acl-applied-interface.png)
Figure 4: ACL applied inbound on the router interface to enforce traffic restrictions.

![Router ACL Configuration](images/router-acl.png)
...
![Guest to Admin Ping Blocked](images/guest-admin-ping-blocked.png)
...
![Staff to Admin Ping Blocked](images/staff-admin-ping-fail.png)
